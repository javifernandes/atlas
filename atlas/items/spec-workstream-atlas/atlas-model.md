---
id: spec-workstream-atlas.atlas-model
kind: territory
title: Atlas Model
...
It is not a complete metamodel yet. It is the smallest shared vocabulary needed to recover product control from scattered plans, implementation work, and historical decisions.

## Child Items

1. [`Semantic Source`](./semantic-source.md)
2. [`Atlas Item`](./atlas-model/item.md)
3. [`Current System Form`](./atlas-model/current-system-form.md)
4. [`Form Transformation`](./atlas-model/form-transformation.md)
5. [`Reconciliation`](./atlas-model/reconciliation.md)
6. [`Model Item`](./atlas-model/model-item.md)
7. [`Atlas Reference`](./atlas-model/atlas-reference.md)
8. [`Work Item`](./atlas-model/work-item.md)
9. [`Evidence Binding`](./atlas-model/evidence-binding.md)
10. [`Relation Model`](./atlas-model/relation-model.md)
...
15. [`Execution Stream`](./atlas-model/execution-stream.md)
